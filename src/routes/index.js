...
import Emails from '../components/subscribe/emails'
import InitContent from '../components/content/InitContent'
import PushContent from '../components/content/PushContent'
            ...
            <Router history={hashHistory}>
                <Route path={'/'} components={Page}>
                    ...
                    <Route path={'app'} component={App}>
                        ...
                        <Route path={'content'}>
                            <Route path={'initContent'} component={InitContent} />
                            <Route path={'push'} component={PushContent} />
